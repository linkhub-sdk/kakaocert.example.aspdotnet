<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="getVerifyAuthresultObj.aspx.cs" Inherits="Kakaocert.Example.Example.getVerifyAuthResult" %>
	...
	<fieldset class="fieldset1">
		...
		<ul>
			...
			<% } else { %>
				...
				<li>returnToken (응답 토큰) : <%=resultObj.returnToken %> </li>
