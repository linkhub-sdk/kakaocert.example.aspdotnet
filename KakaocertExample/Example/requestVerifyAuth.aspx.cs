...
{
    public partial class requestVerifyAuth : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            /**
             * 본인인증을 요청합니다.
             * - https://www.kakaocert.com/docs/verifyAuth/API/dotnet#RequestVerifyAuth
             */
            ...
            try
            {
                receiptId = Global.kakaocertService.requestVerifyAuth(clientCode, requestObj);
            }
